...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('dashboard') }}" class="brand-link">
        <img src="{{ asset('admin/dist/img/AdminLTELogo.png') }}" alt="Attendance Management System Logo"
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="{{ asset('admin/images/kha.png') }}" class="img-circle elevation-2"
                     alt="User Image">
            </div>
            <div class="info">
                ...
                <li class="nav-item has-treeview {{ (request()->routeIs('reports.*') ? 'menu-open' : null ) }}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item {{ (request()->routeIs('reports.monthly.attendance') ? 'menu-open' : null ) }}">
                            <a href="#"
                               class="nav-link has-treeview {{ (request()->routeIs('reports.monthly.attendance') ? 'active' : null ) }}">
                            ...
                            <ul class="nav nav-treeview">
                                @foreach($monthNames as $monthName)
                                    <li class="nav-item">
                                        <a href="{{ route('reports.monthly.attendance', $monthName) }}"
                                           class="nav-link {{ ( str_contains(request()->fullUrl(), $monthName ) &&  request()->routeIs('reports.monthly.attendance', $monthName)) ? 'active' : null  }}">
                        ...
                        <li class="nav-item ">
                            <a href="{{ route('reports.user.attendance') }}"
                               class="nav-link {{ ( request()->routeIs('reports.user.attendance')) ? 'active' : null  }}">
